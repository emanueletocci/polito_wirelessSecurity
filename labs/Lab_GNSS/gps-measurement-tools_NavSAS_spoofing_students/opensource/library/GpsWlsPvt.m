function gpsPvt = GpsWlsPvt(gnssMeas,allGpsEph,spoof,bRaw)
...
for i=1:N
    ...
    [xHat,~,svPos,H,Wpr,Wrr] = WlsPvt(prs,gpsEph,xo,spoof);%compute WLS solution
    xo = xo + xHat;
